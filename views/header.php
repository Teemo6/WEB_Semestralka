...
<head>
    ...
    <link href="<?= DIR_UTILITY ?>css/betterBootstrap.css" rel="stylesheet">

    <!-- Bootstrap JavaScript -->
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-kenU1KFdBIe4zVF0s0G1M5b4hcpxyD9F7jL+jjXkk+Q2h455rYXK/7HAuoJl+0I4" crossorigin="anonymous"></script>

    <!-- Refresh script -->
    <script src="<?= DIR_UTILITY ?>js/disableFormRefresh.js"></script>
...
<div class="container">
    <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-1 mb-3 border-bottom">
        ...
        <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
            ...
            <li><a href="index.php?page=about" class="nav-link link-success no-underline-link"><h5>O projektu</h5></a></li>
        </ul>
