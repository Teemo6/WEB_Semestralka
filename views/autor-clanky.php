...
<div class="container">
    ...
    <div class="card mt-2">
        <div class="card-header">
            <button class="btn form-control text-start" data-bs-toggle="collapse" data-bs-target="#novyClanek"><h4>Napsat článek</h4></button>
        </div>
    ...
    <div class="card mt-2">
        <div class="card-header">
            <button class="btn form-control text-start" data-bs-toggle="collapse" data-bs-target="#mojeClanky"><h4>Moje články</h4></button>
        </div>
